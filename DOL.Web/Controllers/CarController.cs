...
namespace DOL.Web.Controllers
{
    ...
    public class CarController : BaseController
    {
        ...
        /// <returns></returns>
        public JsonResult Add(Car entity)
        {
            ...
            {
                var result = WebService.Add_Car(entity);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public JsonResult Update(Car entity)
        {
            ModelState.Remove("UpdaterID");
            ModelState.Remove("UpdatedTime");
            ModelState.Remove("CreatedTime");
            if (ModelState.IsValid)
            {
                var result = WebService.Update_Car(entity);
                return JResult(result);
            }
            else
            {
        ...
        {
            return JResult(WebService.Find_Car(ID));
        }
